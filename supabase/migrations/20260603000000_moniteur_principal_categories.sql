-- Moniteur principal (un seul par auto-école) + plusieurs catégories enseignées
...
-- Un seul moniteur principal par auto-école
...
-- Reprendre les catégories déjà renseignées (colonne historique)
